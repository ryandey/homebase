...
function Logo() {
  ...
  switch (resolvedTheme) {
    case "light":
      src = "/RPD-MARK-DARK.svg";
      break;
    case "dark":
      src = "/RPD-MARK-LIGHT.svg";
      break;
    default:
      src =
  ...
  return <Image src={src} width={40} height={40} alt="Ryan Dey logo" />;
}
