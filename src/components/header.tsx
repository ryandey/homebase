...
export function Header() {
  return (
    <header className="fixed top-0 left-0 z-50 w-full border-b border-accent bg-background py-2">
      <Container className="flex justify-between">
        ...
        {/* Links */}
        <NavigationMenu className="inline-flex align-top">
          <NavigationMenuList>
            {/* Links */}
            {menuItems.map((item) => {
              return (
...
//         <div className={classNames("transition-[visibility] md:visible", menuOpen ? "visible" : "invisible delay-300")}>
//           <nav
